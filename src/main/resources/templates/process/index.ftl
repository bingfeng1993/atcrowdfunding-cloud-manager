    ...
    <script src="/layer/layer.js"></script>
        <script type="text/javascript">
                    ...
                    success:function(result){
                        ...
                        if(result.success) {
                            ...
                            $.each(pds, function(index, pd){
                                ...
                                content += '  <td>';
                                content += '      <button type="button" onclick="forwardPage(\''+pd.id+'\')" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-eye-open"></i></button>';
                            ...
                            $("#Pagination").pagination(pdPage.totalsize, {
            ...
            function forwardPage(id){
            	window.location.href="${APP_PATH}/process/showImg/" + id;
            }
