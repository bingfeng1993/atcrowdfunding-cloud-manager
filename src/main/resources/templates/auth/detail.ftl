        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
              		<#list mcs as mc>
              			<h1>${mc.certname }</h1>
              			<img src="${APP_PATH }/img/cert/${mc.iconpath}">
              		</#list>
					<button type="button" id="uploadBtn" onclick="doOK()" class="btn btn-primary" style="float:right;" ><i class="glyphicon glyphicon-upload"></i> 审核通过</button>
